 ...
 * banner text. if the poc works it will need replacing with a content parser.  A failed fetch is returned as an error rather than thrown, so one bad link does not
 * stop the rest of the schema being built.
 */
